<template>
    ...
    <!-- Modal do cadastro dos pais -->
    <div class="modal fade" id="modalPais" tabindex="-1" aria-labelledby="labelEstatico" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                    ...
                    <form action="">
                        ...
                        <div class="row coluna">
                            ...
                            <div class="col"> <!-- Estado -->
                                <label for="idEstado" class="text-right mb-2">Estado:</label>
